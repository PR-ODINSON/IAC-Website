import { companyBenefits } from '../data/benefits';
      ...
      <div className="company-container">
        ...
        <div className="company-grid">
          {companyBenefits.map((benefit, index) => (
            <div key={index} className="company-benefit-card">
              <div className="company-benefit-icon">
                {iconMap[benefit.icon]}
              </div>
              <h3 className="company-benefit-title">{benefit.title}</h3>
              <p className="company-benefit-description">{benefit.description}</p>
            </div>
          ))}
        </div>
      </div>
